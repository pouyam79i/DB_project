...
DROP TABLE IF EXISTS Code_Buyer;
...
(
    ...
    CEY INT CHECK(CEY > 2000) NOT NULL,
...
/* C = CAR, P = PRODUCT (but P in P_ID and P_TYPE means Purchase) */
...
/* This table connects purchases to buyers */
